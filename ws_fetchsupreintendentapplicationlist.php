<?php
	...
	if(isset($_POST['supreintendent_id'])){
		$result=mysql_query("SELECT s.name, s.enroll_no, s.hostel_no, s.hostel_id, n.id normaloutpass_id, n.status, n.room, n.bed, n.address, n.fromdate, n.tilldate, n.purpose_of_leave, n.entrytime from tbl_student s, tbl_normaloutpass n, tbl_user u where s.id=n.student_id and n.hostel_id=u.hostel_id and u.id='".$_POST['supreintendent_id']."' order by entrytime desc");
